...
* Copy or rename the module directory to aiessay.
* Replace all occurances of aiessay in files with the new name for your question type.
* Rename files that have aiessay replacing aiessay with the new name for your question type.
* Replace '@copyright  2024 Jesse Songok (YOURCONTACTINFO)' with something like @copyright  2016 Marcus Green (mgreen@example.org)
