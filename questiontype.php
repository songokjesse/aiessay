...
/**
 * Question type class for the aiessay question type.
 *
 * @package    qtype
 * @subpackage aiessay
...
require_once($CFG->dirroot . '/question/type/aiessay/question.php');


/**
 * The aiessay question type.
 *
 * @copyright  2024 Jesse Songok (YOURCONTACTINFO)
...
class qtype_aiessay extends question_type {
    ...
    public function extra_question_fields() {
        return array('question_aiessay', 'somefieldname','anotherfieldname');
    }
    ...
    public function save_question_options($question) {
        global $DB;
        $options = $DB->get_record('question_aiessay', array('questionid' => $question->id));
        if (!$options) {
        ...
        $DB->update_record('question_aiessay', $options);
 ...
 **/
   ...
   public function initialise_question_answers(question_definition $question, $questiondata,$forceplaintextanswers = true){ 
    ...
    public function import_from_xml($data, $question, qformat_xml $format, $extra = null) {
        if (!isset($data['@']['type']) || $data['@']['type'] != 'question_aiessay') {
            return false;
        }
    ...
    public function export_to_xml($question, qformat_xml $format, $extra = null) {
        ...
        $gapfillinfo = $pluginmanager->get_plugin_info('question_aiessay');
